...
| [dnd-kit](https://github.com/clauderic/dnd-kit) | Drag/drop UX | MIT, verified direct dep | 4 | Adopted | Palette-to-page drag/drop for Sign PDF and drag-reorder for Merge PDF. |
...
- Merge PDF now uses dnd-kit sortable interactions for reorderable batch assembly while keeping the actual merge engine in pdf-lib.
